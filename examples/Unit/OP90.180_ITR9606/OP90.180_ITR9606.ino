...
* date：2021/8/16
*******************************************************************************
  Please connect to Port B(32),Detect the current OP 90/180 Unit Photoelectric switch status.
  请连接端口B(32),检测当前OP 90/180单元光电开关状态。
*/
...
void setup() {
  ...
  pinMode(32,INPUT_PULLUP); //Set pin 32 to input pull-up mode.  设置32号引脚为输入上拉模式
}
