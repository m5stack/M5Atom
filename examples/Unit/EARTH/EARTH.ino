...
* date：2021/8/11
*******************************************************************************
  Please connect to Port A(32、26),Read the analog quantity and digital quantity returned by the EARTH unit, and convert the analog quantity into 12-bit data and display it on the screen.
  请连接端口A(32、26),读取EARTH Unit 返回的模拟量和数字量，并将模拟量转换为12位数据显示在屏幕上。
*/
