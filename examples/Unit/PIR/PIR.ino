...
* date：2021/8/11
*******************************************************************************
  Please connect to Port A(32),Human body detection using PIR Unit.
  请连接端口A(32),使用PIR Unit进行人体检测。
*/
...
void loop() {
  if(digitalRead(32)==1){ //If pin 32 reads a value of 1.  如果32号引脚的读取到的值为1
